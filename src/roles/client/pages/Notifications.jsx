...
const mockNotifications = [
  {
    ...
    message: 'Maria Santos placed a bid on "E-commerce Website Development"',
    time: '5 min ago',
    read: false,
    icon: FiBriefcase,
  ...
  },
  {
    ...
    type: 'message',
    title: 'New Message',
    message: 'Juan Reyes sent you a message about the logo design project',
    time: '1 hour ago',
    read: false,
  ...
  },
  {
    ...
    type: 'job',
    title: 'Job Completed',
    message: 'Ana Garcia marked "Social Media Management" as completed',
    time: '1 day ago',
    read: true,
    icon: FiCheckCircle,
    iconColor: 'text-green-500',
